...
const page = async () => {
  const session = await getServerSession(authOptions);
        ...
        return<PageWrapper>
          <div className='relative h-[75vh] w-[100vh]'>
            ...
            <div className='flex justify-center pb-[10vh]'>
              <Image src={logo} alt='Inpatient logo' width={150} height={150} style={{maxWidth: '100%', height: 'auto',}}></Image>
            </div>
    ...
    return <PageWrapper><h2 className="text-red-500 text-xl">กรุณาเข้าสู่ระบบก่อน</h2></PageWrapper>;
}
export default page;