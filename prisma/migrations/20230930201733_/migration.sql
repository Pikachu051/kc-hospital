...
CREATE TABLE "Doctor" (
    ...
    "dFirstName" VARCHAR(80) NOT NULL,
    "dLastName" VARCHAR(80) NOT NULL,
    "dept_id" VARCHAR(10) NOT NULL,
...
ALTER SEQUENCE "Doctor_doctor_id_seq" MINVALUE 10001 START 10001 RESTART 10001;

ALTER SEQUENCE "Patientinfo_hnid_seq" MINVALUE 6600001 START 6600001 RESTART 6600001;